...
There are 7 variables for each pet. I determined this by running ?seattlepets in console and it said there were 7 variables in the dataframe.
...
Some names that are more common for cats than dogs are Oliver and Lily. The names below the line are more common for cats than dogs.
...
The relationship between the proportion of cats with a given name and proportion of dogs with a given name is positive. In the context of the data, this means that if a name is more popular with cats, it is more likely to be popular with dogs.
