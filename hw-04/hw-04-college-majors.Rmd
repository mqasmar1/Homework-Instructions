...
I think the graph with binwidth as 5000 is more intuitive to read and better shows the general shape of the distribution.
...
I think that the minimum and maximum are helpful for describing the distribution, as the minimum median earnings across college majors is 22,000 dollars while the maximum is 110,000 dollars. The graph is skewed right, which is represented in the quartile ranges. The median of the median earnings across majors is 36,000 dollars which is much closer to the 1st quartile of 33,000 dollars compared to the 3rd quartile of 45,000 dollars. One unusual observation is that the range of the dataset is very large. More specifically, the range is 88,000 dollars. 
